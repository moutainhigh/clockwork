...
public class FixFillData {
    ...
    public void fixBreakFillData() {
        ...
        taskPojo.setScriptParameter("/user/adx/triangle/runTimeDir/shell/moonbox/DFS_20210108_moonbox-submit_204057337575505928.sh /user/adx/triangle/runTimeDir/shell/moonbox -n12332_93850_[sql-1] -shttp://moonbox1.adx.jishu.idc:9090 -uadx@p94 -p2A741CAC32D7A67E0BF7B5B53A0FF22B -dc4p94_default -lmql -f/user/adx/triangle/runTimeDir/shell/dataworks/batch/94/12332/93850/93850.mql -Cspark.executor.memory=6g,spark.driver.memory=6g,spark.driver.cores=2,spark.executor.cores=2,spark.executor.instances=10,spark.sql.shuffle.partitions=32");
