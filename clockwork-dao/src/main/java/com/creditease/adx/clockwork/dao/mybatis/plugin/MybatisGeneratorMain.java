...
public class MybatisGeneratorMain {
    ...
    private static void setDataSource(Configuration config, ApplicationContext context) {
        ...
        jdbcConfiguration.setConnectionURL("jdbc:mysql://10.143.177.14:4322/adx_clockwork?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull");
        jdbcConfiguration.setUserId("adx_clockwork");
        jdbcConfiguration.setPassword("adx_clockwork_123");
