    ...
    <div class="app-container">
        ...
        <div class="form-box">
            <el-form :model="form" :rules="rules" label-width="100px" ref="form">
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="任务描述">
                            <el-input placeholder="请描述任务功能" v-model="form.description"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="脚本目录" prop="location">
                            <el-select @change="getCommand()" style="width:50%;float:left;" v-model="locationPrefix">
                                <el-option :key="index" :value="item" v-for="(item,index) in locationPrefixList">
                                    {{item}}
                                </el-option>
                            </el-select>

                            <el-tooltip class="item" content="选择根目录后在此填写后面的路径" effect="dark" placement="top">
                                <el-input @input="(e) => getCommand()" style="width:50%;float:left;"
                                          v-model="locationSuffix"></el-input>
                            </el-tooltip>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="脚本名称" prop="scriptName">
                            <el-input @input="(e) => getCommand()" v-model="form.scriptName"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="脚本参数">
                            <el-input @input="(e) => getCommand()" placeholder="请输入脚本参数"
                                      v-model="form.scriptParameter"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="执行命令">
                            <el-input disabled placeholder="请输入执行命令，例如：test.sh" v-model="form.command"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="所属类型" prop="isPrivate">
                            <el-select placeholder="请选择" v-model="form.isPrivate">
                                <el-option key="1" label="私有(仅同部门可见)" value="true"></el-option>
                                <el-option key="0" label="公有(全公司可见)" value="false"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="触发方式" prop="triggerMode">
                            <el-select @visible-change="handTriggerMode" placeholder="请选择任务触发方式"
                                       v-model="form.triggerMode">
                                <el-option key="1" label="时间触发" value="1"></el-option>
                                <el-option key="0" label="依赖触发" value="0"></el-option>
                                <el-option key="2" label="时间触发和依赖触发" value="2"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="重试次数">
                            <el-input-number :min="0" placeholder="失败重试次数"
                                             v-model="form.failedRetries"></el-input-number>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="任务组" prop="groupName">
                            <el-autocomplete :fetch-suggestions="querySearchTaskGroup" :on-click="deleteSearchGroup"
                                             class="inline-input" placeholder="搜索任务所属的任务组"
                                             v-model="form.groupName"></el-autocomplete>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="任务超时时间">
                            <el-input-number :min="1" placeholder="失败重试次数" v-model="form.runTimeout"></el-input-number>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="执行机组" prop="nodeGid">
                            <el-select placeholder="请选择任务执行机组" v-model="form.nodeGid">
                                <el-option :key="item.id" :label="item.name" :value="item.id"
                                           v-for="item in form.nodeGroupSelect"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="任务来源" prop="source"> <!-- 不能修改 -->
                            <el-select :disabled="disabledSource" class="handle-input" size="medium"
                                       v-model="form.source">
                    ...
                    <el-col :span="12">
                        <el-form-item label="执行引擎" prop="runEngine">
                            <el-select placeholder="请选择" v-model="form.runEngine">
                                ...
                                <el-option key="presto" label="presto" value="presto"></el-option>
                                <el-option key="moonbox" label="moonbox" value="moonbox"></el-option>
                                <el-option key="unknown" label="unknown" value="unknown"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="内部变量">
                            <el-input placeholder="JSON格式" v-model="form.parameter"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="代理用户">
                            <el-input placeholder="用这个代理用户来执行脚本" v-model="form.proxyUser"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="失效时间">
                            <el-col :span="11">
                                <el-date-picker @change="setExpiredTime" format="yyyy-MM-dd HH:mm:ss"
                                                placeholder="选择日期时间"
                                                type="datetime" v-model="form.expiredTime"></el-date-picker>
                            </el-col>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="邮件列表">
                            <el-input placeholder="如果多个邮件请以英文逗号分隔" v-model="form.emailList"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="上传脚本">
                            <el-col>
                                <el-upload :action="uploadFileUrl" :auto-upload="false" :data="form"
                                           :file-list="fileList"
                                           class="upload-demo" drag multiple ref="upload">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item class="submit-item">
                            ...
                            <el-button @click="submitForm('form')" icon="el-icon-document-add" type="primary">提交
                            </el-button>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <!-- dialog 触发方式选项 弹窗-->
                <el-dialog :visible.sync="dialogVisible" title="触发方式选项" width="75%">
                    <!-- 时间 -->
                    <el-form-item label="触发时间" prop="triggerTime"
                                  v-if="form.triggerMode === '1' || form.triggerMode === '2'">
                        <el-date-picker :clearable='false' :disabled="form.checkPattern" @change="setTriggerTime"
                                        format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期时间" style="width:46%;"
                                        type="datetime" v-model="form.triggerTime">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label="执行频率" prop="runFrequency"
                                  v-if="form.triggerMode === '1' ||form.triggerMode === '2'">
                        <el-row>
                            <el-col :span="11">
                                <el-input :disabled="form.checkPattern" @change="handleTriggerParamChange"
                                          v-model="form.runFrequency"></el-input>
                            </el-col>
                            <el-col :span="1" class="line">-</el-col>
                            <el-col :span="12">
                                <el-select :disabled="form.checkPattern" @change="handleTriggerParamChange"
                                           placeholder="请选择"
                                           v-model="form.timeType">
                                    <el-option key="day" label="天/次" value="day"></el-option>
                                    <el-option key="week" label="周/次" value="week"></el-option>
                                    <el-option key="month" label="月/次" value="month"></el-option>
                                    <el-option key="year" label="年/次" value="year"></el-option>
                                    <el-option key="century" label="世纪/次" value="century"></el-option>
                                    <el-option key="minute" label="分钟/次" value="minute"></el-option>
                                    <el-option key="hour" label="小时/次" value="hour"></el-option>
                                </el-select>
                            </el-col>
                        </el-row>
                    </el-form-item>
                    ...
                    <div v-if="form.triggerMode === '1' || form.triggerMode === '2'">
                        ...
                        <el-form-item label="CRON模式">
                            <el-switch @change="handleCheckPattern" v-model="form.checkPattern"></el-switch>
                        </el-form-item>
                        <el-form-item label="CRON表达式">
                            <el-input :disabled="!form.checkPattern" v-model="form.cronExp" width="90%"></el-input>
                        </el-form-item>
                    </div>

                    <!-- 依赖任务相关 -->
                    <el-form-item label="选择依赖" prop="dependencyId"
                            ...
                            <template>
                                ...
                                >
                                    ...
                                    <template v-slot:leftCondition="{scope}">
                                        <el-row :gutter="10">
                                            <el-col :span="9">
                                                <el-input placeholder="任务Id" size="medium"
                                                          v-model="scope.id"></el-input>
                                            </el-col>
                                            <el-col :span="9">
                                                <el-input placeholder="任务名" size="medium"
                                                          v-model="scope.name"></el-input>
                                            </el-col>
                                        </el-row>
                                    </template>
                                    <template v-slot:rightCondition="{scope}">
                                        <el-row>
                                            <el-col :span="9">
                                                <el-input placeholder="任务名称" size="medium"
                                                          v-model="scope.name"></el-input>
                                            </el-col>
                                        </el-row>
                                    </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            // 弹出框ok
            ok() {
                if (this.form.triggerMode === "1" || this.form.triggerMode === "2") {// 触发时间相关
                    if (!this.form.checkPattern) { // 未选中CRON表达式
                        if (this.form.triggerTime === "" || this.form.timeType === "" || this.form.runFrequency === "") {
                            this.$message({
                                message: "时间触发相关字段必填",
                                type: "warning",
                            });
                ...
                if (this.form.triggerMode === "0" || this.form.triggerMode === "2") { // 依赖触发相关
            ...
            getData() { // 加载任务相关数据
                ...
                _self.axios.get("/clockwork/web/task/getTaskJSONObjectById", {
                    params: {
                        taskId: taskId
                    },
                })
                    .then((response) => {
                        if (response.code === "OK") {
                            ...
                            if (_self.form.triggerMode === "1" || _self.form.triggerMode === "2") { // 时间触发相关
                                ...
                                if (_self.form.triggerTime === null || _self.form.triggerTime === ''
                                    || _self.form.runFrequency === null || _self.form.runFrequency === ''
                                    || _self.form.timeType === null || _self.form.timeType === '') {
                                    _self.form.checkPattern = true;
                                    _self.checkPattern = true;
                                }
                            }
                            if (_self.form.triggerMode === "0" || _self.form.triggerMode === "2") { // 依赖触发相关
                                if (response.data.dependencyId != null) {
                                    this.getDependentTasks(response.data.dependencyId); // 获取依赖任务初始化数据
                                }
                            }
                            if (_self.form.triggerMode === "4") {    // 信号触发
                                _self.form.customScript =
                                    response.data.customScript;
                            }
            ...
            paginationCallBack(obj) {
                ...
                let d = this.transferDependencyData.filter((item, index) => {
                    ...
                    if (size >= (obj.pageIndex - 1) * obj.pageSize && size < obj.pageIndex * obj.pageSize) {
                        // 那页的数据需要展示
                        return true;
                    }
                    return false;
            ...
            getTransferDependencyData() {
                ...
                _self.axios.get("/clockwork/web/task/getTaskIdAndNameByUserNameNotInThisId", {
                    params: {
                        userName: userName,
            ...
            getCommand() {
                if (this.locationSuffix) {
                    ...
                    this.form.command = (this.form.location + '/' + this.form.scriptName + ' ' + this.form.scriptParameter).trim(); //执行命令
                } else {
                    this.form.location = this.locationPrefix; //脚本目录
                    this.form.command = (this.locationPrefix + this.form.scriptName + ' ' + this.form.scriptParameter).trim(); //执行命令
                }
            },
            submitForm(formName) {
                let task = {};
                ...
                if (this.form.triggerMode === "1" || this.form.triggerMode === "2") { // 时间触发相关
                    task.timeType = this.form.timeType;
                    task.runFrequency = this.form.runFrequency;
                    task.triggerTime = this.form.triggerTime;
                }
                if (this.form.triggerMode === "0" || this.form.triggerMode === "2") { // 依赖任务相关
                    const dpIds = [];
                    if (this.tableData == null || this.tableData === '' || this.tableData.length === 0) {
                        this.$message({
                ...
                if (this.form.expiredTime === null || this.form.expiredTime === undefined ||
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        _self.axios
                            .post("/clockwork/web/task/operation/updateTask", JSON.stringify(task), {
                                    headers: {
            ...
            createFilterTaskGroup(queryString) {
                return (taskGroup) => {
                    ...
                    return taskGroup.value.toLowerCase().indexOf(queryString.toLowerCase()) !== -1
                };
            },
            ...
            getNodeGroup() {
                let _self = this;
                _self.axios.get("/clockwork/web/node/group/getAllNodeGroup", {}).then((response) => {
            ...
            getUploadPathPrefix() {
                let _self = this;
                _self.axios.get('/clockwork/web/task/uploadPathPrefix').then((res) => {
                    _self.locationPrefixList = res.data;
                    const rtn = res.data.map(i => ({raw: i, len: i.length}))
            ...
            getDependentTasks(ids) {
                this.axios.get('/clockwork/web/task/getTaskByTaskIds', {
                    params: {
                        ids: ids
                    }
                }).then((res) => {
