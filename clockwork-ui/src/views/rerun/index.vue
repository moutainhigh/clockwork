<template>
    <div class="app-container">
            ...
            <div class="box_l">
                <div class="inner_contain">
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-input class="handle-input" clearable placeholder="任务名称" v-model="taskName"/>

                        </el-col>
                        <el-col :span="8">
                            <el-input class="handle-input" clearable placeholder="批次号" type="number"
                        ...
                        <el-row>
                            <el-col :span="8">
                                <el-input class="handle-input" clearable
                                          ...
                                          placeholder="taskId" type="number" v-model="taskId"></el-input>
                            </el-col>
                            <el-col :span="8">
                                <el-input class="handle-input" clearable placeholder="操作人" v-model="operatorName"/>
                            </el-col>
                            <el-col :span="8">
                            </el-col>
                        </el-row>
        ...
        <el-table :data="tableData" append border ref="singleTable" style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="任务名" prop="taskName" width="180"></el-table-column>
            ...
            <el-table-column label="参数" prop="parameter" width="160"></el-table-column>
            <el-table-column label="日志名" prop="logName" width="280"></el-table-column>
            <el-table-column label="nodeId" prop="nodeId" width="80"></el-table-column>
            <el-table-column label="nodeIp" prop="nodeIp" width="160"></el-table-column>
            <el-table-column label="nodePort" prop="nodePort" width="80"></el-table-column>
            ...
            <el-table-column fixed="left" label="操作" width="100">
                <template slot-scope="scope">
                    <div class="operate-block">
                        <el-tooltip class="item" content="查看日志" effect="dark" placement="top">
                            <em><i @click="handleCatLogFile(scope.row)" class="el-icon-postcard"></i></em>
                        </el-tooltip>
                        <el-tooltip class="item" content="重新运行" effect="dark" placement="top">
                            <em><i @click="handleRerunTask(scope.row)" class="el-icon-refresh-left"></i></em>
                        </el-tooltip>
                    </div>
                </template>
            </el-table-column>
        ...
        methods: {
            ...
            getData: function () {
                ...
                pageParam.condition = JSON.stringify({
                    ...
                    executeType: this.executeType === '' || this.executeType == null ? 0 : this.executeType,
                    startTime: this.startTime === '' || this.executeType === 2 ? null : this.startTime,
                    endTime: this.endTime === '' || this.executeType === 2 ? null : this.endTime,
                });
                _self.tableData = [];
                _self.axios.post('/clockwork/web/task/rerun/searchTaskRerunPageList', JSON.stringify(pageParam), {
                    headers: {
            ...
            handleRerunTask(row) {
                let _self = this;
                _self.axios.post('/clockwork/web/task/operation/rerunTaskHis', _self.qs.stringify({
                    taskId: row.taskId,
                    logId: row.logId,
                    taskReRunType: 0,
