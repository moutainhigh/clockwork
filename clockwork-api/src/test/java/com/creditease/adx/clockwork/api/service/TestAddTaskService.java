...
public class TestAddTaskService {
    ...
    public void addTaskBatch() {
        ...
        for (int i = 1; i <= 5000; i++) {
            ...
            task.setDependencyId(null);
            task.setGroupId(516);
            task.setCreateUser("mingliu51@creditease.cn");
            task.setOperatorName("mingliu51@creditease.cn");
            task.setEmailList("mingliu51@creditease.cn");
            task.setRunTimeout(0);
            task.setExpiredTime(null);
            task.setParameter(null);
            task.setProxyUser(null);
            ...
            String URL = "http://10.143.151.104:9005/clockwork/api/task/operation/addTask";
