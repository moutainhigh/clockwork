...
public class TaskSubmitService implements ITaskSubmitService {
     ...
     */
    @Override
    public TaskSubmitInfoRerun submitReRunTaskTx(Integer taskId, Integer taskReRunType, String parameter, String operatorName) {

        // 预处理 - 重启任务信息
        List<TbClockworkTaskPojo> taskPojoList = preProcessReRunTask(taskId, taskReRunType, null, parameter, operatorName);
    ...
    public TaskSubmitInfoRerun submitReRunTaskHisTx(@RequestParam(value = "taskId") Integer taskId,
        ...
        // 预处理 - 重启任务信息
        List<TbClockworkTaskPojo> taskPojoList = preProcessReRunTask(taskId, taskReRunType, logId, parameter, operatorName);
        if (CollectionUtils.isEmpty(taskPojoList)) {
    ...
    private List<TbClockworkTaskPojo> preProcessReRunTask(
            Integer taskId, int executeType, Integer logId, String parameter, String operatorName) {
     ...
     * @return
     */
    private List<TbClockworkTaskPojo> getAllChildrenAndSelfIncludeFailedFather(Integer taskId) {
