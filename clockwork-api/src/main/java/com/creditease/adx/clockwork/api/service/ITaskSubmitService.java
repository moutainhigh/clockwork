...
public interface ITaskSubmitService {
     ...
     */
    TaskSubmitInfoRerun submitReRunTaskTx(Integer taskId, Integer taskReRunType, String parameter, String operatorName);
     ...
     * @param operatorName  操作人
     */
    TaskSubmitInfoRerun submitReRunTaskHisTx(Integer taskId, Integer taskReRunType, Integer logId, String parameter, String operatorName);
